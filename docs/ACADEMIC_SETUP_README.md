...
| `stage` | `string?` | المرحلة (ابتدائي، إعدادي، ثانوي، …) |
...
> - كل هذا يحدث في **Transaction واحدة** (آمن ضد race conditions)
...
```json
{
  "grades": [
    ...
    { "dictionaryId": 2, "sortOrder": 2 },
    { "dictionaryId": 3, "sortOrder": 3 },
    { "dictionaryId": 4, "sortOrder": 4 },
    { "dictionaryId": 5, "sortOrder": 5 },
    { "dictionaryId": 6, "sortOrder": 6 },
    { "displayName": "تمهيدي", "shortName": "تمهيدي", "sortOrder": 0 }
  ],
  "year": {
    "name": "2025-2026",
    "startDate": "2025-09-01",
